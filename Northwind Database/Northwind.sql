...
INSERT INTO Products (Product_Name, Supplier_ID, Categoryid, Unit, Price)
VALUES
...
CREATE TABLE Shippers(
    Shipper_ID INT GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE OrderDetails (
    Order_DetailID INT GENERATED ALWAYS AS IDENTITY,
    Order_ID INT,
    Product_ID INT,
    Quantity INT,
